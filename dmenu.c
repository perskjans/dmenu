...
/* enums */
enum { SchemeNorm, SchemeSel, SchemeOut, SchemeMid, SchemeNormHighlight,
       SchemeSelHighlight, SchemeLast }; /* color schemes */
...
main(int argc, char *argv[])
{
	...
	for (i = 1; i < argc; i++)
		...
		if (!strcmp(argv[i], "-v")) {      /* prints version information */
			...
			fstrstr = cistrstr;
		} else if (!strcmp(argv[i], "-r")) /* dont't reject input which results in no match */
			reject_no_match = 0;
		else if (i + 1 == argc)
			usage();
